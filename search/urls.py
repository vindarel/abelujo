...
urlpatterns = patterns('',
    ...
    url(r'^commands/ongoing/?',
        ...
        name='commands_ongoing'),
    url(r'^commands/empty$', 'search.views.basket_auto_command_empty',
        name="basket_auto_command_empty"),
    ...
    url(r'^commands/supplier/(?P<pk>\d+|all)/?$', 'search.views.command_supplier',
    ...
    # Client Reservations
    url(r'^reservations/?$', 'search.views.reservations', name="reservations"),
