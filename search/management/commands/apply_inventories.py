...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("""Notice: the "apply" command is asynchronous. It exits right away,
        but it calls a redis-based task queue (huey). This service MUST be started, otherwise
        applying the inventory will have no effect.
        See "make taskqueue".
