...
apipatterns = patterns("",
    ...
    url(r'^api/cards/quickcreate/?$', 'search.models.api.card_quickcreate', name="api_card_quickcreate"),
    ...
    url(r'^api/card/(?P<pk>\d+)/cancelreservation/(?P<client_id>\d+)/?', 'search.models.api.card_cancel_reservation', name="api_card_cancel_reservation"),
    url(r'^api/card/(?P<pk>\d+)/reservations/?', 'search.models.api_users.card_reservations', name="api_card_reservations"),
    url(r'^api/card/reserved/?$', 'search.models.api_users.reserved_cards', name="api_reserved_cards"),
    ...
    url(r'^api/card/(?P<pk>\d+)/exclude_catalogue/?$', 'search.models.api.card_exclude_catalogue', name="api_card_exclude_catalogue"),
    ...
    url(r'^api/baskets/(?P<pk>\d+)/add_to_stock/?', 'search.models.api.baskets_add_to_stock', name="api_basket_add_to_stock"),
    ...
    url(r'^api/baskets/(?P<pk>\d+)/import/?', 'search.views.basket_import', name="basket_import"),
